...
// Service provides methods to interact with Placeholders-related API endpoints.
...
func (api *Service) config() *signplusconfig.Config {
	return api.manager.GetPlaceholders()
}
...
func (api *Service) SetEnvelopeAttachmentsPlaceholders(ctx context.Context, envelopeID string, setEnvelopeAttachmentsPlaceholdersRequest SetEnvelopeAttachmentsPlaceholdersRequest, params SetEnvelopeAttachmentsPlaceholdersRequestParams, opts ...signplusconfig.RequestOption) ([]byte, error) {
	config := *api.config()
