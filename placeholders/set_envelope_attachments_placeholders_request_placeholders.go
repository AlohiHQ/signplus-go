...
type SetEnvelopeAttachmentsPlaceholdersRequestPlaceholders struct {
	...
	Multiple    *param.Nullable[string] `json:"multiple,omitempty" xml:"multiple,omitempty"`
...
func (s SetEnvelopeAttachmentsPlaceholdersRequestPlaceholders) String() string {
	jsonData, err := json.MarshalIndent(s, "", "  ")
	if err != nil {
		return "error converting struct: SetEnvelopeAttachmentsPlaceholdersRequestPlaceholders to string"
	}
	return string(jsonData)
}

func (s *SetEnvelopeAttachmentsPlaceholdersRequestPlaceholders) UnmarshalJSON(data []byte) error {
