...
// Service provides methods to interact with TemplateTemplateIDSetComment-related API endpoints.
...
func (api *Service) config() *signplusconfig.Config {
	return api.manager.GetTemplateTemplateIDSetComment()
}
...
func (api *Service) SetTemplateComment(ctx context.Context, templateID string, setTemplateCommentRequest SetTemplateCommentRequest, params SetTemplateCommentRequestParams, opts ...signplusconfig.RequestOption) ([]byte, error) {
	config := *api.config()
