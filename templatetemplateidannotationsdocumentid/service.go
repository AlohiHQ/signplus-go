...
// Service provides methods to interact with TemplateTemplateIDAnnotationsDocumentID-related API endpoints.
...
func (api *Service) config() *signplusconfig.Config {
	return api.manager.GetTemplateTemplateIDAnnotationsDocumentID()
}
...
func (api *Service) GetDocumentTemplateAnnotations(ctx context.Context, templateID string, documentID string, params GetDocumentTemplateAnnotationsRequestParams, opts ...signplusconfig.RequestOption) ([]byte, error) {
	config := *api.config()
