...
// Service provides methods to interact with Void-related API endpoints.
...
// Void envelope
func (api *Service) VoidEnvelope(ctx context.Context, envelopeID string, params VoidEnvelopeRequestParams, opts ...signplusconfig.RequestOption) ([]byte, error) {
	config := *api.config()
