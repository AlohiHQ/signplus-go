...
// Service provides methods to interact with TemplateTemplateIDDocument-related API endpoints.
...
func (api *Service) config() *signplusconfig.Config {
	return api.manager.GetTemplateTemplateIDDocument()
}
...
func (api *Service) AddTemplateDocument(ctx context.Context, templateID string, addTemplateDocumentRequest AddTemplateDocumentRequest, params AddTemplateDocumentRequestParams, opts ...signplusconfig.RequestOption) ([]byte, error) {
	config := *api.config()
