...
import (
	...
	"github.com/alohihq/signplus-go/internal/contenttypes"
	"github.com/alohihq/signplus-go/internal/serialization"
	"github.com/alohihq/signplus-go/internal/utils"
...
type Request struct {
	...
	Options             any
	Body                any
	Config              signplusconfig.Config
	ContentType         ContentType
	ResponseContentType ContentType
}

func NewRequest(ctx context.Context, method string, path string, config signplusconfig.Config) Request {
	return Request{
		Context:             ctx,
		Method:              method,
		Path:                path,
