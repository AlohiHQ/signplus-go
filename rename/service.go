...
// Service provides methods to interact with Rename-related API endpoints.
...
// Rename envelope
func (api *Service) RenameEnvelope(ctx context.Context, envelopeID string, renameEnvelopeRequest RenameEnvelopeRequest, params RenameEnvelopeRequestParams, opts ...signplusconfig.RequestOption) ([]byte, error) {
	config := *api.config()
