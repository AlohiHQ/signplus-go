...
// Service provides methods to interact with Document-related API endpoints.
...
func (api *Service) config() *signplusconfig.Config {
	return api.manager.GetDocument()
}
...
func (api *Service) AddEnvelopeDocument(ctx context.Context, envelopeID string, addEnvelopeDocumentRequest AddEnvelopeDocumentRequest, params AddEnvelopeDocumentRequestParams, opts ...signplusconfig.RequestOption) ([]byte, error) {
	config := *api.config()
