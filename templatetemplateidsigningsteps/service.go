...
// Service provides methods to interact with TemplateTemplateIDSigningSteps-related API endpoints.
...
func (api *Service) config() *signplusconfig.Config {
	return api.manager.GetTemplateTemplateIDSigningSteps()
}
...
func (api *Service) AddTemplateSigningSteps(ctx context.Context, templateID string, addTemplateSigningStepsRequest AddTemplateSigningStepsRequest, params AddTemplateSigningStepsRequestParams, opts ...signplusconfig.RequestOption) ([]byte, error) {
	config := *api.config()
