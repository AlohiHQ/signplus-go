...
// Service provides methods to interact with Send-related API endpoints.
...
func (api *Service) SendEnvelope(ctx context.Context, envelopeID string, params SendEnvelopeRequestParams, opts ...signplusconfig.RequestOption) ([]byte, error) {
	config := *api.config()
