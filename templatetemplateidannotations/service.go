...
// Service provides methods to interact with TemplateTemplateIDAnnotations-related API endpoints.
...
func (api *Service) config() *signplusconfig.Config {
	return api.manager.GetTemplateTemplateIDAnnotations()
}
...
func (api *Service) GetTemplateAnnotations(ctx context.Context, templateID string, params GetTemplateAnnotationsRequestParams, opts ...signplusconfig.RequestOption) ([]byte, error) {
	config := *api.config()
