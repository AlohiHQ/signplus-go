...
// Service provides methods to interact with TemplateID-related API endpoints.
...
func (api *Service) config() *signplusconfig.Config {
	return api.manager.GetTemplateID()
}
...
func (api *Service) CreateEnvelopeFromTemplate(ctx context.Context, templateID string, createEnvelopeFromTemplateRequest CreateEnvelopeFromTemplateRequest, params CreateEnvelopeFromTemplateRequestParams, opts ...signplusconfig.RequestOption) ([]byte, error) {
	config := *api.config()
