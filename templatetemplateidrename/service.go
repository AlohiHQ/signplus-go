...
// Service provides methods to interact with TemplateTemplateIDRename-related API endpoints.
...
func (api *Service) config() *signplusconfig.Config {
	return api.manager.GetTemplateTemplateIDRename()
}
...
// Rename template
func (api *Service) RenameTemplate(ctx context.Context, templateID string, renameTemplateRequest RenameTemplateRequest, params RenameTemplateRequestParams, opts ...signplusconfig.RequestOption) ([]byte, error) {
	config := *api.config()
