...
type ListEnvelopesRequest struct {
	...
	OnlyRootFolder *param.Nullable[bool]     `json:"only_root_folder,omitempty" xml:"only_root_folder,omitempty"`
	DateFrom       *param.Nullable[float64]  `json:"date_from,omitempty" xml:"date_from,omitempty"`
	DateTo         *param.Nullable[float64]  `json:"date_to,omitempty" xml:"date_to,omitempty"`
	...
	IncludeTrash   *param.Nullable[bool]     `json:"include_trash,omitempty" xml:"include_trash,omitempty"`
}
