...
// Service provides methods to interact with FileID-related API endpoints.
...
func (api *Service) GetAttachmentFile(ctx context.Context, envelopeID string, fileID string, params GetAttachmentFileRequestParams, opts ...signplusconfig.RequestOption) ([]byte, error) {
	config := *api.config()
