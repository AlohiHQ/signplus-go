...
// Service provides methods to interact with Settings-related API endpoints.
...
func (api *Service) config() *signplusconfig.Config {
	return api.manager.GetSettings()
}
...
func (api *Service) SetEnvelopeAttachmentsSettings(ctx context.Context, envelopeID string, setEnvelopeAttachmentsSettingsRequest SetEnvelopeAttachmentsSettingsRequest, params SetEnvelopeAttachmentsSettingsRequestParams, opts ...signplusconfig.RequestOption) ([]byte, error) {
	config := *api.config()
