...
// Service provides methods to interact with Templates-related API endpoints.
...
func (api *Service) config() *signplusconfig.Config {
	return api.manager.GetTemplates()
}
...
// List templates
func (api *Service) ListTemplates(ctx context.Context, listTemplatesRequest ListTemplatesRequest, params ListTemplatesRequestParams, opts ...signplusconfig.RequestOption) ([]byte, error) {
	config := *api.config()
