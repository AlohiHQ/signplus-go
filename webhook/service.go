...
// Service provides methods to interact with Webhook-related API endpoints.
...
// Create webhook
func (api *Service) CreateWebhook(ctx context.Context, createWebhookRequest CreateWebhookRequest, params CreateWebhookRequestParams, opts ...signplusconfig.RequestOption) ([]byte, error) {
	config := *api.config()
