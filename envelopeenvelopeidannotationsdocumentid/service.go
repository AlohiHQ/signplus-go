...
// Service provides methods to interact with EnvelopeEnvelopeIDAnnotationsDocumentID-related API endpoints.
...
func (api *Service) config() *signplusconfig.Config {
	return api.manager.GetEnvelopeEnvelopeIDAnnotationsDocumentID()
}
...
func (api *Service) GetEnvelopeDocumentAnnotations(ctx context.Context, envelopeID string, documentID string, params GetEnvelopeDocumentAnnotationsRequestParams, opts ...signplusconfig.RequestOption) ([]byte, error) {
	config := *api.config()
